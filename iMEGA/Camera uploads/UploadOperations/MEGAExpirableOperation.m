...
- (void)start {
    ...
    dispatch_source_set_timer(self.expireTimer, dispatch_time(DISPATCH_TIME_NOW, (int64_t)(self.expireTimeInterval * NSEC_PER_SEC)), (uint64_t)(self.expireTimeInterval * NSEC_PER_SEC), 1 * NSEC_PER_SEC);
