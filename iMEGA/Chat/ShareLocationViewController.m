...
- (void)viewDidLoad {
    ...
    if (!CLLocationManager.locationServicesEnabled || CLLocationManager.authorizationStatus == kCLAuthorizationStatusDenied || CLLocationManager.authorizationStatus == kCLAuthorizationStatusRestricted) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:AMLocalizedString(@"Please allow access", @"Title of the string Please allow access") message:message preferredStyle:UIAlertControllerStyleAlert];
