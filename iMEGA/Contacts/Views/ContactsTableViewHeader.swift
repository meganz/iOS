...
class ContactsTableViewHeader: UIView {
    ...
    override func awakeFromNib() {
        ...
        requestsLabel.text = AMLocalizedString("Requests", "Label for any ‘Requests’ button, link, text, title, etc. On iOS is used to go to the Contact request section from Contacts")
        ...
        groupsLabel.text = AMLocalizedString("Groups", "Label for any ‘Groups’ button, link, text, title, etc. On iOS is used to go to the chats 'Groups' section from Contacts")
