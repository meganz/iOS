...
- (IBAction)moreAction:(UIBarButtonItem *)sender {
    ...
    [actions addObject:[ActionSheetAction.alloc initWithTitle:(self.layoutView == LayoutModeList) ? AMLocalizedString(@"Thumbnail view", @"Text shown for switching from list view to thumbnail view.") : AMLocalizedString(@"List view", @"Text shown for switching from thumbnail view to list view.") detail:nil image:[UIImage imageNamed:@"thumbnailsThin"] style:UIAlertActionStyleDefault actionHandler:^{
