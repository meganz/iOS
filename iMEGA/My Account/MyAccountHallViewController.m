...
- (void)viewDidLoad {
    ...
    MEGAContactLinkCreateRequestDelegate *delegate = [[MEGAContactLinkCreateRequestDelegate alloc] initWithCompletion:^(MEGARequest *request) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
            ...
            UIImage *image = [UIImage mnz_qrImageWithDotsFromString:destination withSize:qrImageSie color:[UIColor mnz_turquoiseForTraitCollection:self.traitCollection]];
