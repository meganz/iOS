...
struct DeviceIconProviderTestSuite {
    ...
    @Test("Returns correct icon based on user agent string", arguments: [
       ...
       // Linux desktop
       ("Mozilla/5.0 (X11; Linux x86_64)", false, "pc-linux"),
       // Mac desktop
       ("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)", false, "pc-mac"),
       // Windows desktop
       ("Mozilla/5.0 (Windows NT 10.0; Win64; x64)", false, "pc-windows"),
