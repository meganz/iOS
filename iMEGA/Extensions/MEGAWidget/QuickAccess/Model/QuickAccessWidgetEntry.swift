...
struct QuickAccessWidgetEntry: TimelineEntry {
    ...
    static func placeholder() -> QuickAccessWidgetEntry {
        QuickAccessWidgetEntry(date: Date(),
                               ...
                               value: ([QuickAccessItemModel(thumbnail: Image("generic"),name: "File.txt", url: URL(fileURLWithPath: "mega://widget.quickaccess.reload"), image: nil, description: nil)], .connected))
    }
}
