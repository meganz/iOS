...
@class MyAvatarManager, PhotoLibraryContentViewModel, PhotoUpdatePublisher, PhotoSelectionAdapter, PhotosBannerViewModel;
...
@property (strong, nonatomic) PhotosBannerViewModel *photosBannerViewModel;
