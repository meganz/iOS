...
protocol DownloadFileRepositoryProtocol: RepositoryProtocol {
    ...
    func downloadFile(forNodeHandle handle: HandleEntity, to url: URL, filename: String?, appdata: String?, startFirst: Bool, cancelToken: MEGACancelToken, start: ((TransferEntity) -> Void)?, update: ((TransferEntity) -> Void)?, folderUpdate: ((FolderTransferUpdate) -> Void)?, completion: ((Result<TransferEntity, TransferErrorEntity>) -> Void)?)
