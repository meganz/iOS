...
final class AddPhoneNumberViewModelTests: XCTestCase {
    ...
    func testAction_onViewReady_achievementSuccess() {
        ...
        let text = String(format: AMLocalizedString("Get free %@ when you add your phone number. This makes it easier for your contacts to find you on MEGA."), Helper.memoryStyleString(fromByteCount: 1000))
