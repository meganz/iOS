...
class ActionViewModelTests: XCTestCase {
    ...
    func test_fileActionsShouldShowItemView() {
        let nameCollisionAction = NameCollisionAction(actionType: .merge, name: "File name", isFile: true)
    ...
    func test_folderActionShouldNotShowItemView() {
        let nameCollisionAction = NameCollisionAction(actionType: .merge, name: "Folder name", isFile: false)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_actionWithName() {
        let nameCollisionAction = NameCollisionAction(actionType: .merge, name: "name", isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
        XCTAssert(viewModel.itemName == nameCollisionAction.name)
    }
    
    func test_actionWithoutName() {
        let nameCollisionAction = NameCollisionAction(actionType: .merge, isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
        XCTAssert(viewModel.itemName == "")
    }
    
    func test_titleForMergeAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .merge, name: "name", isFile: false)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_titleForUpdateAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .update, name: "name", isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_titleForReplaceAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .replace, name: "name", isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_titleForRenameAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .rename, name: "name", isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_titleForSkipFolderAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .cancel, name: "name", isFile: false)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
    ...
    func test_titleForSkipFileAction() {
        let nameCollisionAction = NameCollisionAction(actionType: .cancel, name: "name", isFile: true)
        let viewModel = ActionViewModel(actionItem: nameCollisionAction)
