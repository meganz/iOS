...
+ (NSMutableAttributedString *)mnz_darkenSectionTitleInString:(NSString *)string sectionTitle:(NSString *)sectionTitle {
    ...
    if ([string rangeOfString:sectionTitle].location != NSNotFound) {
        ...
        if (stringWithoutSectionTitle != nil) {
            NSMutableAttributedString *stringWithoutSectionTitleMutableAttributedString = [[NSMutableAttributedString alloc] initWithString:stringWithoutSectionTitle attributes:@{NSFontAttributeName:[UIFont mnz_SFUIRegularWithSize:18.0f], NSForegroundColorAttributeName:[UIColor mnz_gray999999]}];
            
            NSMutableAttributedString *sectionTitleMutableAttributedString = [[NSMutableAttributedString alloc] initWithString:sectionTitle attributes:@{NSFontAttributeName:[UIFont mnz_SFUIRegularWithSize:18.0f], NSForegroundColorAttributeName:[UIColor mnz_gray777777]}];
