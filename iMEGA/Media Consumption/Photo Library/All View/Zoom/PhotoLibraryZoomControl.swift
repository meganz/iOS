...
struct PhotoLibraryZoomControl: View {
    ...
    private func zoomInButton() -> some View {
        ...
        .foregroundColor(zoomState.canZoom(.in) ? Color.photosZoomButtonForeground : MEGAAppColor.Gray._8E8E93.color)
    ...
    private func zoomOutButton() -> some View {
        ...
        .foregroundColor(zoomState.canZoom(.out) ? Color.photosZoomButtonForeground : MEGAAppColor.Gray._8E8E93.color)
