...
public final class MockNodeTransferRepository: NodeTransferRepositoryProtocol {
    ...
    public let transferStartUpdates: AnyAsyncSequence<TransferEntity>
    ...
    public init(
        transferStartUpdates: AnyAsyncSequence<TransferEntity> = EmptyAsyncSequence().eraseToAnyAsyncSequence(),
        ...
        self.transferStartUpdates = transferStartUpdates
