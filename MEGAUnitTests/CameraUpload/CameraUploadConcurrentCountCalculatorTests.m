    ...
    for (NSNumber *batteryState in self.batteryChargingStates) {
        for (NSNumber *batteryLevel in self.sampleBatteryLevels) {
            if (@available(iOS 11.0, *)) {
                ...
                CameraUploadConcurrentCounts counts = [self.calculator calculateCameraUploadConcurrentCountsByApplicationState:UIApplicationStateBackground batteryState:batteryState.integerValue batteryLevel:batteryLevel.floatValue isLowPowerModeEnabled:YES];
    ...
    for (NSNumber *batteryState in self.batteryChargingStates) {
        for (NSNumber *batteryLevel in self.sampleBatteryLevels) {
            if (@available(iOS 11.0, *)) {
                ...
                CameraUploadConcurrentCounts counts = [self.calculator calculateCameraUploadConcurrentCountsByApplicationState:UIApplicationStateBackground batteryState:batteryState.integerValue batteryLevel:batteryLevel.floatValue isLowPowerModeEnabled:NO];
