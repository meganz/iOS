...
extension DateFormatter {
    ...
    @objc static func dateRelativeShort(calendar: Calendar? = nil,
                                         timeZone: TimeZone? = nil,
                                         locale: Locale? = nil) -> DateFormatting {
        systemDateFormatter(dateStyle: .short, timeStyle: .none, isRelative: true, calendar: calendar, timeZone: timeZone, locale: locale)
    }
    ...
    @objc static func dateRelativeLong(calendar: Calendar? = nil,
                                       timeZone: TimeZone? = nil,
                                       locale: Locale? = nil) -> DateFormatting {
        systemDateFormatter(dateStyle: .long, timeStyle: .none, isRelative: true, calendar: calendar, timeZone: timeZone, locale: locale)
    }
    ...
    @objc static func dateRelativeFull(calendar: Calendar? = nil,
                                       timeZone: TimeZone? = nil,
                                       locale: Locale? = nil) -> DateFormatting {
        systemDateFormatter(dateStyle: .full, timeStyle: .none, isRelative: true, calendar: calendar, timeZone: timeZone, locale: locale)
    }
